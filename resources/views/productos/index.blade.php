...
@section('main-content')
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <h1><div class="card-header">Productos</div></h1>
                    <div class="card-body">
...
<br>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Modelo</th><th>Cantidad</th><th>Descripcion</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($productos as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->Modelo }}</td><td>{{ $item->Cantidad }}</td><td>{{ $item->Descripcion }}</td>
                                        <td>
