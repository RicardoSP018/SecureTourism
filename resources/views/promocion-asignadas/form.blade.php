<div class="form-group {{ $errors->has('paquete_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="paquete_id" type="number" id="paquete_id" value="{{ isset($promocionasignada->paquete_id) ? $promocionasignada->paquete_id : ''}}" >
...
<div class="form-group {{ $errors->has('promocion_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="promocion_id" type="number" id="promocion_id" value="{{ isset($promocionasignada->promocion_id) ? $promocionasignada->promocion_id : ''}}" >
